   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <script>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" id="cdescription" name="cdescription" placeholder="Enter Course Description" value="" required>
      ...
      <?php
        ...
        {
          $new_sql="SELECT COUNT(c_name) from course where c_name='".$cname."' and college_id=$Clgid and dept_id='".$Deptid."'";
          $new_result=mysqli_query($connection, $new_sql);
          $new_row=mysqli_fetch_row($new_result);
          if($new_row[0]==0)
          {

            $new_sql="INSERT INTO course(c_name,c_duration,c_description,dept_id,college_id) VALUES('".$cname."',$cduration,'".$cdescription."',$Deptid,$Clgid)";
