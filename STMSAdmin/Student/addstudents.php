...
<body>
    ...
    <nav class="navbar py-3 navbar-expand-sm bg-dark navbar-dark fixed-top">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:8.3%;margin-top:-1%;">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:14.1%;margin-top:-1%;">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:21.94%;margin-top:-1%;">
                <span class="decorate"><a class="dropdown-item" href="../Course/addcourse.php"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Course</a></span>
                <span class="decorate"><a class="dropdown-item" href="../Course/coursereports.php"><i class="fa fa-file"></i>&nbsp;&nbsp;Course Reports</a></
              </div>
          </li>
          <li class="nav-item">
              <a class="nav-link dropdown-toggle" href="#" id="navbardrop"  data-toggle="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:28%;margin-top:-1%;">
                <span class="decorate"><a class="dropdown-item" href="addstudent.php"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Add Student</a></span>
              </div>
          </li>
          <li class="nav-item">
              <a class="nav-link dropdown-toggle" href="#" id="navbardrop"  data-toggle="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:34.24%;margin-top:-1%;">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:39.94%;margin-top:-1%;">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" auto-complete="off" placeholder="Enter the Student Name" id="name" name="name" pattern="^[a-zA-Z ]{2,30}$" value="" required>
          <div class="invalid-tooltip">Please enter the Student Name!</div>
        </div>
    </div>
    <div class="form-group row">
        <label for="profile_pic" class="col-sm-2 col-form-label">Student Profile<br>Photo</label>
        <div class="col-sm-5">
          ...
          <div class="invalid-tooltip">Please upload the Student Image!</div>
        </div>       
    </div>
    <div class="form-group row ">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-5">
            <input type="number" class="form-control" id="rollno" name="rollno" min="1" pattern="^\d{1,}$" value="<?php echo $_POST['rollno'];?>" required>
        </div>
      </div>
      <div class="form-group row">
      <label for="add" class="col-sm-2 col-form-label" ></label>
        <div class="col-sm-3">
          <button type="submit" name="add" class="btn btn-primary" onclick="myFunction()">Add Student Details</button>
        </div>
      </div>
      <script>
          function myFunction() 
          {
             document.getElementById("rollno").stepUp(1);
          }
      </script>
      <?php
        ...
        if(isset($_POST['add']) && $_FILES['filepath']["error"]==0)
        {
            ...
            if($new_row[0]==0)
            {
                ...
                {?>
                    ...
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Error!</strong>
                    Student Details could not be inserted!<?php echo mysqli_error($connection);?>
                    </div> 
                    <?php
                }
            }
            ...
            {?>
                ...
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <strong>Error!</strong> Student with the given name already exists!
                </div>
                <?php
            }
            $new_sql="SELECT COUNT(username) from log_in where username='".$uemail."' and role_id=3";
            $new_result=mysqli_query($connection, $new_sql);
            $new_row=mysqli_fetch_row($new_result);
            if($new_row[0]==0)
            {
                $nms = explode(' ',$uname);
                $pass = $nms[0]."@123";
                $new_sql="INSERT INTO log_in(username,pass,role_id,user_id) VVALUES('".$uemail."','".MD5($pass)."',3,$UID)";
                if(mysqli_query($connection, $new_sql))
                {?>
                    <div class="alert alert-success alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Success!</strong> Student Login Details given successfully!
                    </div>
                  <?php
                }
                else
                {?>
                    ...
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Error!</strong>
                    Student Login Details could not be given successfully!<?php echo mysqli_error($connection);?>
                    </div> 
                  <?php
                }
            }
            ...
            {?>
                <div class="alert alert-warning alert-dismissable">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <strong>Error!</strong> Student Login already exists!
                </div>
                <?php
            }
            $new_sql="SELECT COUNT(user_id) from student WHERE semester='".$semester."' and dept_id='".$deptid."' and college_id='".$clgid."' and course_id='".$courseid."' and user_id in(SELECT user_id from user WHERE u_name='".$uname."' and email='".$uemail."')";
            $new_result=mysqli_query($connection, $new_sql);
            $new_row=mysqli_fetch_row($new_result);
            if($new_row[0]==0)
            {
                $new_sql="INSERT INTO student(roll_no,semester,user_id,dept_id,college_id,course_id) VALUES($rno,$semester,$UID,$deptid ,$clgid,$courseid)";
                if(mysqli_query($connection, $new_sql))
                {?>
                    <div class="alert alert-success alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Success!</strong> Student Added into College successfully!
                    </div>
                  <?php
                }
                else
                {?>
                    ...
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong>Error!</strong>
                    Student could not be added successfully!<?php echo mysqli_error($connection);?>
                    </div> 
                  <?php
                }
            }
            ...
            {?>
                <div class="alert alert-warning alert-dismissable">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <strong>Error!</strong> Student with the given name has already taken admission in college!
                </div>
                <?php
            }
        }
