...
<head>
  ...
  <body>
    <nav class="navbar py-3 navbar-expand-sm bg-dark navbar-dark fixed-top">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:33.4%;margin-top:-1.1%;">
    ...
    <form action="addstudents.php" method="POST" class="center" novalidate id="needs-validation" enctype="multipart/form-data">
    <h3>Add Student</h3>
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <script>
        $(function() 
        {
            ...
            var toggleDropdown = function(clg) 
            {
                ...
                if($("#clg").val()=="")
                    $("#cname,#sem").prop('disabled', !hasClg).val('');
                    //$("#sem").prop('disabled', !hasClg).val('');
            }
    ...
    <script>
        ...
        {
            // Generic logic
            var toggleDropdown = function(cname) 
            {
                // hasOwner is a boolean store

                var hasCname = typeof cname !== typeof undefined && cname;

                // Use boolean to decide whether to disable/enable dep field
                $('#sem').prop('disabled', !hasCname).val('');
            }
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-5">
            <select name="sem" id="sem" class="form-control" style="position: relative; top: 1%; height: 100%;" required disabled>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-5">
            <input type="number" class="form-control" id="rollno" name="rollno" min="1" placeholder="Enter the Roll Number starting from" pattern="^\d{1,}$" value="" required>
            <div class="invalid-tooltip">Please Enter the Starting Roll Number!</div>
        </div>
      </div>
      <div class="form-group row">
