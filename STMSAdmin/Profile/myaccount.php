  ...
  <body>
    ...
    <nav class="navbar py-3 navbar-expand-sm bg-dark navbar-dark fixed-top">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:21.91%;margin-top:-1%;">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:27.96%;margin-top:-1%;">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu" style="margin-left:39.91%;margin-top:-1%;">
   ...
   <h3>My Profile</h3>
      <div class="form-group row">
        ...
        <div class="col-sm-5">
          <img src="<?php echo$photo;?>" width="100px" height="100px" style="border-radius:50%; border: 1px solid white;"/>
  ...
  // if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["filepath"]["tmp_name"],$target_dir."user".$_SESSION['uid'].'.'.$imageFileType))
      ...
      <div class="alert alert-success alert-dismissible">
        ...
        mysqli_query($connection, "UPDATE user SET photo_path='".$path.""."user".$_SESSION['uid'].'.'.$imageFileType."' WHERE user.user_id=".$_SESSION['uid']);
